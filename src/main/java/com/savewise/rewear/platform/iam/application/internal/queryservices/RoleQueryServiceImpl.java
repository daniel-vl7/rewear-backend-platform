package com.savewise.rewear.platform.iam.application.internal.queryservices;

import com.savewise.rewear.platform.iam.domain.model.entities.Role;
import com.savewise.rewear.platform.iam.domain.model.queries.GetAllRolesQuery;
import com.savewise.rewear.platform.iam.domain.model.queries.GetRoleByNameQuery;
import com.savewise.rewear.platform.iam.domain.services.RoleQueryService;
