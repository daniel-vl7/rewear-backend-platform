package com.savewise.rewear.platform.iam.infrastructure.authorization.sfs.pipeline;
 ...
 * <p>
 *     This class is used by the {@link BearerAuthorizationRequestFilter} to handle unauthorized requests.
 *     The {@link BearerAuthorizationRequestFilter} is responsible for filtering the incoming requests and
 *     checking if the request contains a valid bearer token. If the request does not contain a valid bearer token, the {@link UnauthorizedRequestHandlerEntryPoint}
