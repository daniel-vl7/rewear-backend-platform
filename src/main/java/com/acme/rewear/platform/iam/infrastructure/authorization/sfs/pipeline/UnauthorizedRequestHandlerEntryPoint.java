package com.acme.rewear.platform.iam.infrastructure.authorization.sfs.pipeline;
 ...
 * <p>
 *     This class is used by the {@link com.acme.rewear.platform.iam.infrastructure.authorization.sfs.pipeline.BearerAuthorizationRequestFilter} to handle unauthorized requests.
 *     The {@link com.acme.rewear.platform.iam.infrastructure.authorization.sfs.pipeline.BearerAuthorizationRequestFilter} is responsible for filtering the incoming requests and
 *     checking if the request contains a valid bearer token. If the request does not contain a valid bearer token, the {@link com.acme.rewear.platform.iam.infrastructure.authorization.sfs.pipeline.UnauthorizedRequestHandlerEntryPoint}
